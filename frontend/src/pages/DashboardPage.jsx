...
import { Utensils, CheckCircle, XCircle, Grid, Plus, ArrowRight, ShieldCheck, TrendingUp } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Silently handle initial dashboard load errors
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        {loading ? (
          <LoadingSpinner message="Loading catalog data..." />
        ) : items.length === 0 ? (
