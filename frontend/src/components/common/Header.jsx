...
import { Utensils, Sun, Moon, LogOut, User, Shield, Menu, X } from 'lucide-react';
          ...
          <div className="flex items-center space-x-3">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              ...
              <div className="hidden sm:block">
                <span className="font-heading text-lg font-bold text-slate-900 dark:text-slate-100">
                  ...
                  <div className="absolute right-0 mt-2 w-48 saas-card p-1 shadow-lg z-50 divide-y divide-slate-100 dark:divide-slate-800">
                    ...
                    <div className="py-1">
                      <Link
                        ...
                        className="flex items-center space-x-2 px-3 py-2 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg"
                      >
                    ...
                    <div className="pt-1">
                      <button
                        ...
                        className="w-full flex items-center space-x-2 px-3 py-2 text-xs font-semibold text-red-600 hover:bg-red-50 dark:hover:bg-red-950/50 rounded-lg"
                      >
